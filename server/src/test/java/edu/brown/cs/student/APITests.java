...
public class APITests {
  ...
  public void testAddListingSuccess() throws IOException {
    ...
    HttpURLConnection loadConnection =
        tryRequest(
            "add-listing?seller_id=100&title=pencil&available=true&description=yellow+pencil&price=0.01&category=Other&condition=New&image_url=dummy.png&tags=fiction,thriller");
    ...
    assertEquals("dummy.png", responseBody.get("imageUrl"));
